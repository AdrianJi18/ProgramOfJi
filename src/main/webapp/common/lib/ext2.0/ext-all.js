...
Ext.DomHelper = function() {
    ...
    return {
        ...
        doInsert: function(s, u, t, v, r) {
            ...
            var q;
            if (this.useDom) {
                q = o(u, null); (r === "firstChild" ? s: s.parentNode).insertBefore(q, r ? s[r] : s)
            } else {
                var p = a(u);
...
Ext.Fx = {
    ...
    shift: function(b) {
        ...
        function() {
            ...
            if (c !== undefined || k !== undefined) {
                e.points = {
                    to: [c !== undefined ? c: this.getX(), k !== undefined ? k: this.getY()]
                }
            }
            if (i !== undefined) {
                e.opacity = {
    ...
    fxanim: function(d, e, b, g, c, a) {
        b = b || "run";
        e = e || {};
        var h = Ext.lib.Anim[b](this.dom, d, (e.duration || g) || 0.35, (e.easing || c) || "easeOut",
        function() {
            Ext.callback(a, this)
        },
        this);
...
Ext.Updater = Ext.extend(Ext.util.Observable, {
    ...
    update: function(b, g, h, d) {
        if (this.fireEvent("beforeupdate", this.el, b, g) !== false) {
            ...
            {
                url: b,
                params: (typeof g == "function" && c) ? g.createDelegate(c) : g,
...
Ext.UpdateManager = Ext.Updater; (function() {
    function xf(format) {
    ...
    Ext.apply(Date, {
        ...
        parseCodes: {
            ...
            c: function() {
                var calc = [],
                arr = [$f("Y", 1), $f("m", 2), $f("d", 3), $f("h", 4), $f("i", 5), $f("s", 6), {
                ...
                return {
                    g: 1,
                    c: calc.join(""),
                    s: arr[0].s + "-" + arr[1].s + "-" + arr[2].s + "T" + arr[3].s + ":" + arr[4].s + ":" + arr[5].s + "((.|,)\\d+)?(Z|([+-]\\d{2}:\\d{2}))"
                }
            },
            U: {
                g: 1,
...
Ext.Element.measureText = Ext.util.TextMetrics.measure; (function() {
...
Ext.data.ArrayReader = Ext.extend(Ext.data.JsonReader, {
    readRecords: function(c) {
        ...
        var h = this.recordType,
        q = h.prototype.fields;
        var e = [];
        var s = c;
    ...
    Ext.extend(Ext.Layer, Ext.Element, {
        ...
        constrainXY: function() {
            if (this.constrain) {
                ...
                var k = n[0],
                g = n[1];
                var l = this.dom.offsetWidth + this.shadowOffset,
        ...
        for (g = 0; g < m; g++) {
            ...
            if (p.anchor) {
                ...
                if (!r) {
                    ...
                    p.anchorSpec = r = {
                        right: this.parseAnchor(t[0], p.initialConfig.width, d),
                        bottom: this.parseAnchor(t[1], p.initialConfig.height, q)
                    }
                }
...
Ext.layout.ColumnLayout = Ext.extend(Ext.layout.ContainerLayout, {
    ...
    onLayout: function(d, k) {
        ...
        var m = o.width - k.getPadding("lr") - this.scrollOffset,
        b = o.height - k.getPadding("tb"),
        n = m;
...
Ext.extend(Ext.tree.TreeNode, Ext.data.Node, {
    ...
    destroy: function() {
        if (this.childNodes) {
            for (var b = 0,
            a = this.childNodes.length; b < a; b++) {
...
Ext.form.DateField = Ext.extend(Ext.form.TriggerField, {
    ...
    parseDate: function(d) {
        ...
        if (!b && this.altFormats) {
            ...
            for (var c = 0,
            a = this.altFormatsArray.length; c < a && !b; c++) {
    ...
    onRender: function(k, g) {
        if (!this.el) {
            ...
            if (this.items[0].items) {
                ...
                if (this.vertical) {
                    var s = Math.ceil(this.items.length / d),
                    p = 0;
                    for (var e = 0,
                    n = this.items.length; e < n; e++) {
                        if (e > 0 && e % s == 0) {
